<template>
  <div>
      ...
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        ...
        <el-form-item label="标签" prop="tags">
          <el-select v-model="tagsArr" multiple filterable allow-create default-first-option style="width: 100%">
            <el-option value="新生求助"></el-option>
            <el-option value="每日一问"></el-option>
            <el-option value="毕业季"></el-option>
            <el-option value="学习方法"></el-option>
            <el-option value="分享心得"></el-option>
            <el-option value="我爱师大"></el-option>
          </el-select>
        </el-form-item>
    ...
    <el-dialog title="文章内容" :visible.sync="fromVisible1" width="50%" :close-on-click-modal="false" :append-to-body="true" destroy-on-close>
      <div class="w-e-text">
